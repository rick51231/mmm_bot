...
VIDEO_STEP_4 = env.str("VIDEO_STEP_4")
COMPANY_URL = env.str("COMPANY_URL")
TEXT_STEP_1 = env.str("TEXT_STEP_1")
TEXT_STEP_2 = env.str("TEXT_STEP_2")
TEXT_STEP_3 = env.str("TEXT_STEP_3")
TEXT_STEP_4_PART_1 = env.str("TEXT_STEP_4_PART_1")
TEXT_STEP_4_PART_2 = env.str("TEXT_STEP_4_PART_2")
